...
-(void)updateColor{
    ...
    [containerVC.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:74/255.0 green:135/255.0 blue:235/255.0 alpha:1]];
...
[ [UINavigationBar appearance] setBarStyle:UIBarStyleBlack];// 电池条，白色
    ...
    //back bar button
    UIBarButtonItem* backBarBtn =[[UIBarButtonItem alloc]initWithImage:[self reSizeImage:[UIImage  imageNamed:@"nav_back"] toSize:CGSizeMake(13, 20)] style:UIBarButtonItemStylePlain target:self action:@selector(pop)];
//    UIBarButtonItem* backBarBtn =[[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"nav_back"] style:UIBarButtonItemStylePlain target:self action:@selector(pop)];
